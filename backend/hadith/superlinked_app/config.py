...
class Settings(BaseSettings):
    ...
    QDRANT_URL_BASE: os.getenv("QDRANT_URL_BASE")  # Add QDRANT_URL_BASE parameter
    QDRANT_API_KEY: os.getenv("QDRANT_API_KEY")  # Add QDRANT_API_KEY parameter
...
settings = Settings(dataset_type="hadist")  # USE_QDRANT akan otomatis True
